...
class Configuration:
    ...
    # This flag add support for multiple servers running simultanously
    # e.g. two xlpro workbooks open and running at the same time
    MULTI_SERVER_EXPERIMENT: bool = field(default=False)
